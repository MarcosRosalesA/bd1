...
DROP TABLE marca_model CASCADE CONSTRAINTS;
...
ALTER TABLE trabajo
    ADD CONSTRAINT relation_10 FOREIGN KEY ( id_estado )
        REFERENCES status ( id_estado );

ALTER TABLE vehiculo
    ADD CONSTRAINT relation_13 FOREIGN KEY ( id_marca )
        REFERENCES marca_model ( id_marca );

ALTER TABLE trabajo
    ADD CONSTRAINT relation_2 FOREIGN KEY ( id_cliente )
        REFERENCES cliente ( id_cliente );

ALTER TABLE trabajo
    ADD CONSTRAINT relation_5 FOREIGN KEY ( id_servicio )
        REFERENCES servicio ( id_servicio );

ALTER TABLE repuestos
    ADD CONSTRAINT relation_8 FOREIGN KEY ( id_servicio )
        REFERENCES servicio ( id_servicio );

ALTER TABLE vehiculo
    ADD CONSTRAINT relation_9 FOREIGN KEY ( cliente_id_cliente )
        REFERENCES cliente ( id_cliente );
